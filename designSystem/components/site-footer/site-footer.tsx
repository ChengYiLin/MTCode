export function SiteFooter() {
  return (
    <footer className="mt-7 flex flex-wrap items-center justify-between gap-4 rounded-3xl bg-white px-[30px] py-[26px] shadow-sm">
      <div className="text-sm leading-[1.7] text-muted-foreground">
        © 2005 ~ 2026 高見龍
        <br />
        使用 ♥ 與 Ruby + Rails 打造
      </div>
      <div className="flex gap-[18px] text-muted-foreground/60">
        {/* YouTube */}
        <a
          href="#"
          aria-label="YouTube"
