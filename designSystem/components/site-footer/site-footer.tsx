  ...
  return (
    <footer className="mt-7 flex flex-wrap items-center justify-between gap-4 rounded-hh-l bg-white px-[30px] py-[26px] shadow-hh-20">
      ...
      <div className="flex gap-[18px] text-hh-text-disabled">
        {/* YouTube */}
        <a href="#" aria-label="YouTube" className="transition-colors hover:text-hh-primary">
        ...
        {/* GitHub */}
        <a href="#" aria-label="GitHub" className="transition-colors hover:text-hh-primary">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Mail */}
        <a href="#" aria-label="Email" className="transition-colors hover:text-hh-primary">
        ...
        {/* RSS */}
        <a href="#" aria-label="RSS" className="transition-colors hover:text-hh-primary">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
