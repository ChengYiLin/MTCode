...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      >
        <MediaPlaceholder iconSize={60} className="h-[210px] w-full sm:h-[360px]">
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0)_35%,rgba(0,0,0,.78)_100%)]" />
        </MediaPlaceholder>
        <div className="absolute inset-x-0 bottom-0 px-7 pb-[26px] pt-7 text-white">
          ...
          <div className="mb-3 text-2xl font-semibold leading-[1.2] sm:text-[42px]">
            {hero.title}
          </div>
      ...
      <section className="mt-10">
        <div className="mb-3.5 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-hh-text-primary">合作夥伴</span>
        </div>
        <div className="overflow-hidden [mask-image:linear-gradient(90deg,transparent,#000_6%,#000_94%,transparent)]">
          <div className="flex w-max gap-4 [animation:marquee_32s_linear_infinite]">
      ...
      <section>
        <div className="my-[22px] mt-10 flex items-center gap-[18px]">
          <h2 className="whitespace-nowrap text-[22px] font-semibold text-hh-text-emphasize">
            最新文章
          </h2>
        ...
        <div className="mt-10 flex items-center justify-center gap-2">
          ...
          <Link href="/articles" className="flex h-10 min-w-10 flex-none items-center justify-center rounded-hh-s border border-black/[.12] bg-white text-sm text-hh-text-primary transition-colors hover:bg-hh-primary-tint">
            2
          </Link>
          <Link href="/articles" className="flex h-10 min-w-10 flex-none items-center justify-center rounded-hh-s border border-black/[.12] bg-white text-sm text-hh-text-primary transition-colors hover:bg-hh-primary-tint">
            3
