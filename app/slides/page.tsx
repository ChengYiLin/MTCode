      ...
      <div className="mb-7 rounded-hh-l bg-white px-8 py-[30px] shadow-hh-20">
        ...
        <div className="flex flex-wrap items-end justify-between gap-3.5">
          <div>
            ...
            <p className="text-[15px] text-hh-text-secondary">分享我的演講簡報與教學投影片</p>
          </div>
          <span className="text-sm text-hh-text-secondary">共 {slides.length} 份簡報</span>
        </div>
      </div>
        ...
        {slides.map((slide) => (
          ...
          >
            <div className="relative flex aspect-[16/9] w-full items-center justify-center bg-[linear-gradient(135deg,#d3d8de,#e6e9ed)]">
              <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.92)" strokeWidth="1.3">
                <rect x="3" y="4" width="18" height="12" rx="1.5" />
                <path d="M12 16v4M8 20h8" />
              </svg>
              <span className="absolute bottom-2.5 right-2.5 rounded-hh-s bg-[rgba(31,32,36,.82)] px-[9px] py-0.5 text-xs font-semibold text-white">
                {slide.pages} 頁
              </span>
            </div>
            <div className="px-4 pb-[18px] pt-4">
              <h3 className="mb-2.5 line-clamp-2 text-[18px] font-semibold leading-[1.4]">
                {slide.title}
              </h3>
              ...
              <div className="flex items-center justify-between border-t border-black/[.06] pt-3 text-[13px] text-hh-text-secondary">
                <span className="inline-flex min-w-0 items-center gap-[5px]">
                  <svg className="flex-none" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                    <path d="M12 21s-7-5.2-7-11a7 7 0 0 1 14 0c0 5.8-7 11-7 11z" />
                    <circle cx="12" cy="10" r="2.5" />
                  </svg>
                  <span className="overflow-hidden text-ellipsis whitespace-nowrap">{slide.event}</span>
                </span>
